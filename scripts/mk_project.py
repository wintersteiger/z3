...
def init_project_def():
    ...
    add_lib('experimental_tactics', ['core_tactics', 'smtlogic_tactics'], 'tactic/experimental')
    add_lib('portfolio', ['smtlogic_tactics', 'sat_solver', 'ufbv_tactic', 'fpa_tactics', 'aig_tactic', 'fp',  'qe','sls_tactic', 'subpaving_tactic', 'experimental_tactics'], 'tactic/portfolio')
