...
expr_ref fpa2bv_model_converter_prec::convert_bv2fp(model * bv_mdl, sort * s, expr * bv) const {
    fpa_util fu(m);
    bv_util bu(m);
...
expr_ref fpa2bv_model_converter_prec::convert_bv2rm(expr * eval_v) const {
    fpa_util fu(m);
    bv_util bu(m);
    expr_ref res(m);
    rational bv_val(0);
...
expr_ref fpa2bv_model_converter_prec::convert_bv2rm(model * bv_mdl, func_decl * var, expr * val) const {
    fpa_util fu(m);
    bv_util bu(m);
    expr_ref res(m);
