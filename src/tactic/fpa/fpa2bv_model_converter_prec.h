...
--*/
#ifndef _FPA2BV_MODEL_CONVERTER_PREC_H_
#define _FPA2BV_MODEL_CONVERTER_PREC_H_

#include"fpa2bv_converter_prec.h"
#include"model_converter.h"

class fpa2bv_model_converter_prec : public model_converter {
    ast_manager               & m;
...
public:
    ...
    virtual ~fpa2bv_model_converter_prec() {
